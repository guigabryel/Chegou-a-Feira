...
class Batatapalha extends StatefulWidget {
  const Batatapalha({super.key});

  @override
  State<Batatapalha> createState() => _BatatapalhaState();
}

class _BatatapalhaState extends State<Batatapalha> {
  @override
